...
async def fraud_stream(websocket: WebSocket):
    ...
    while True:
        event = {
            "transaction_id": (
                f"TXN-LIVE-{random.randint(1000,9999)}"
            ),
            ...
            "explanation": (
                "Live simulated fraud event generated "
                "for analyst dashboard streaming."
            ),
        }
